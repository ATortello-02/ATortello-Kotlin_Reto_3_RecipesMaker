...
open class Menu
{
    ...
    fun mostrarAgua(): String? //Función para mostrar lista de Aguas:
    {
        ...
        println("Cuánto deseas de tu selección (${listaAgua[selAgua!!.toInt()-1]})?")
        responseIngr = readLine()

        return "\n${listaAgua[selAgua!!.toInt()-1]}: ${responseIngr!!.toInt()}"
    }
    ...
    fun mostrarLacteos(): String? //Función para mostrar lista de Lácteos:
    {
        ...
        println("Cuánto deseas de tu selección (${listaLacteos[selLacteos!!.toInt()-1]})?")
        responseIngr = readLine()

        return "\n${listaLacteos[selLacteos!!.toInt()-1]}: ${responseIngr!!.toInt()}"
    }
    ...
    fun mostrarCarnes(): String? //Función para mostrar lista de Carnes y Legumbres:
    {
        ...
        println("Cuánto deseas de tu selección (${listaCarnes[selCarnes!!.toInt()-1]})?")
        responseIngr = readLine()

        return "\n${listaCarnes[selCarnes!!.toInt()-1]}: ${responseIngr!!.toInt()}"
    }
    ...
    fun mostrarVerduras(): String? //Función para mostrar lista de Verduras:
    {
        ...
        println("Cuánto deseas de tu selección (${listaVerduras[selVerduras!!.toInt()-1]})?")
        responseIngr = readLine()

        return "\n${listaVerduras[selVerduras!!.toInt()-1]}: ${responseIngr!!.toInt()}"
    }
    ...
    fun mostrarFrutas(): String? //Función para mostrar lista de Frutas:
    {
        ...
        println("Cuánto deseas de tu selección (${listaFrutas[selFrutas!!.toInt()-1]})?")
        responseIngr = readLine()

        return "\n${listaFrutas[selFrutas!!.toInt()-1]}: ${responseIngr!!.toInt()}"
    }
    ...
    fun mostrarCereales(): String? //Función para mostrar lista de Cereales:
    {
        ...
        println("Cuánto deseas de tu selección (${listaCereales[selCereales!!.toInt()-1]})?")
        responseIngr = readLine()

        return "\n${listaCereales[selCereales!!.toInt()-1]}: ${responseIngr!!.toInt()}"
    }
    ...
    fun mostrarHuevos(): String? //Función para mostrar lista de Huevos:
    {
        ...
        println("Cuánto deseas de tu selección (${listaHuevos[selHuevos!!.toInt()-1]})?")
        responseIngr = readLine()

        return "\n${listaHuevos[selHuevos!!.toInt()-1]}: ${responseIngr!!.toInt()}"
    }
    ...
    fun mostrarAceites(): String? //Función para mostrar lista de Aceites:
    {
        ...
        println("Cuánto deseas de tu selección (${listaAceites[selAceites!!.toInt()-1]})?")
        responseIngr = readLine()

        return "\n${listaAceites[selAceites!!.toInt()-1]}: ${responseIngr!!.toInt()}"
    }
}